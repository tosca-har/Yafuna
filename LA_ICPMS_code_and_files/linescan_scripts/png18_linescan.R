...
sample.name	        	<- "PNG18"	                            # is printed in the file-names
...
last.blankValue.linescan		<- 40				        # last  Blank-Value (e.g. line number) used for background-correction

first.sampleValue.linescan  <- 45				        # first Laser-on-sample-Value (e.g. line number) used for analysis
last.sampleValue.linescan	  <- 419			          # last  Laser-on-sample-Value (e.g. line number) used for analysis
