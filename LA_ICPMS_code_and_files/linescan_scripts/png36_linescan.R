...
sample.name	        	<- "PNG36"	                            # is printed in the file-names
...
last.blankValue.linescan		<- 37				        # last  Blank-Value (e.g. line number) used for background-correction

first.sampleValue.linescan  <- 43				        # first Laser-on-sample-Value (e.g. line number) used for analysis
last.sampleValue.linescan	  <- 479			          # last  Laser-on-sample-Value (e.g. line number) used for analysis
