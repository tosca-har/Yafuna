...
sample.name	        	<- "NKD44"	                            # is printed in the file-names
...
first.blankValue.linescan   <- 9			            # first Blank-Value (e.g. line number) used for background-correction
last.blankValue.linescan		<- 32				        # last  Blank-Value (e.g. line number) used for background-correction

first.sampleValue.linescan  <- 37				        # first Laser-on-sample-Value (e.g. line number) used for analysis
last.sampleValue.linescan	  <- 305			          # last  Laser-on-sample-Value (e.g. line number) used for analysis
...
last.blankValue		          <- 31				        # last  Blank-Value (e.g. line number) used for background-correction
...
first.blankValue <- c(18,8,8,8,8,8,9,8)
last.blankValue <- c(43,33,145,44,31,23,19,40)
first.sampleValue <- c(48, 40,154,54,38,48,24,53)			        # first Laser-on-sample-Value (e.g. line number) used for analysis
last.sampleValue <- c(87,93,236,183,80,90,54,168)
