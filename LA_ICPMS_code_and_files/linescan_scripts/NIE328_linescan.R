...
sample.name	        	<- "NIE328"	                            # is printed in the file-names
...
first.blankValue.linescan   <- 10			            # first Blank-Value (e.g. line number) used for background-correction
last.blankValue.linescan		<- 36				        # last  Blank-Value (e.g. line number) used for background-correction

first.sampleValue.linescan  <- 41				        # first Laser-on-sample-Value (e.g. line number) used for analysis
last.sampleValue.linescan	  <- 326			          # last  Laser-on-sample-Value (e.g. line number) used for analysis
...
first.blankValue <- c(8,8,8,8,8,8,8,8)
last.blankValue <- c(31,28,86,32,26,47,46,25)
first.sampleValue <- c(41, 37,101,39,35,54,56,35)			        # first Laser-on-sample-Value (e.g. line number) used for analysis
last.sampleValue <- c(79,70,173,110,70,88,193,110)
