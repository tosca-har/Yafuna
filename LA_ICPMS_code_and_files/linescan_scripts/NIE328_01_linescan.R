...
sample.name	        	<- "NIE328_01"	                            # is printed in the file-names
...
last.blankValue.linescan		<- 19				        # last  Blank-Value (e.g. line number) used for background-correction

first.sampleValue.linescan  <- 25				        # first Laser-on-sample-Value (e.g. line number) used for analysis
last.sampleValue.linescan	  <- 316			          # last  Laser-on-sample-Value (e.g. line number) used for analysis
