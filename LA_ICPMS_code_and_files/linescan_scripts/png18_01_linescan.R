...
sample.name	        	<- "PNG18_01"	                            # is printed in the file-names
...
last.blankValue.linescan		<- 25				        # last  Blank-Value (e.g. line number) used for background-correction

first.sampleValue.linescan  <- 29				        # first Laser-on-sample-Value (e.g. line number) used for analysis
last.sampleValue.linescan	  <- 447			          # last  Laser-on-sample-Value (e.g. line number) used for analysis
