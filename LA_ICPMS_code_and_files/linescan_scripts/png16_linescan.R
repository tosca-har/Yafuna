...
sample.name	        	<- "PNG16"	                            # is printed in the file-names
...
number.sweeps.sample        <- 507				        # No. of sweeps (e.g. overall number of rows)
...
last.blankValue.linescan		<- 23				        # last  Blank-Value (e.g. line number) used for background-correction

first.sampleValue.linescan  <- 30				        # first Laser-on-sample-Value (e.g. line number) used for analysis
last.sampleValue.linescan	  <- 485			          # last  Laser-on-sample-Value (e.g. line number) used for analysis
