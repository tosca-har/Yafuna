...
sample.name	        	<- "PNG37_01"	                            # is printed in the file-names
...
first.sampleValue.linescan  <- 23				        # first Laser-on-sample-Value (e.g. line number) used for analysis
last.sampleValue.linescan	  <- 358			          # last  Laser-on-sample-Value (e.g. line number) used for analysis
