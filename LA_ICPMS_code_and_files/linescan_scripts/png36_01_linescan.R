...
sample.name	        	<- "PNG36_01"	                            # is printed in the file-names
...
last.blankValue.linescan		<- 22				        # last  Blank-Value (e.g. line number) used for background-correction

first.sampleValue.linescan  <- 28				        # first Laser-on-sample-Value (e.g. line number) used for analysis
last.sampleValue.linescan	  <- 442			          # last  Laser-on-sample-Value (e.g. line number) used for analysis
